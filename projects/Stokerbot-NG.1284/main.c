...
int main(void)
{
	...
	uint16_t timer_OW, timer_Simple, timer_Count, timer_EEProm, timer_SendData,
	         timer_IOalarm, timer_network;
	timer_OW = 0;
	timer_Simple = 0;
	timer_Count = 0;
	timer_EEProm = 0;
...
void updateSimpleSensors(void)
{
	...
	for (uint8_t i = 0; i <= 3; i++) {
		...
		if (simpleSensorTypes[i + 8] == TYPE_DIGIN
		    || simpleSensorTypes[i + 8] == TYPE_DIGOUT) { //DIGITAL
